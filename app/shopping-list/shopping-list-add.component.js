System.register(["@angular/core", "../movie", "./shopping-list.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, movie_1, shopping_list_service_1, ShoppingListAddComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ShoppingListAddComponent = (function () {
            ...
            exports_1("ShoppingListAddComponent", ShoppingListAddComponent);
        }
    };
});
